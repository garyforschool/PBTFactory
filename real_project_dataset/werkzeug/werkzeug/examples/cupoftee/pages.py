...
class ServerList(Page):
    ...
    def process(self):
        ...
        sort_func = {'name': lambda x: x, 'map': lambda x: x.map,
            'gametype': lambda x: x.gametype, 'players': lambda x: x.
            player_count, 'progression': lambda x: x.progression}.get(self.
            order_by)
        ...
        self.players = sorted(self.players, key=lambda a, b: unicodecmp(a.
            name, b.name))
