...
class TestDebugRepr:
    ...
    def test_string_repr(self):
        ...
        assert debug_repr('s' * 80
            ) == f'<span class="string">&#39;{\'s\' * 69}<span class="extended">{\'s\' * 11}&#39;</span></span>'
        assert debug_repr('<' * 80
            ) == f'<span class="string">&#39;{\'&lt;\' * 69}<span class="extended">{\'&lt;\' * 11}&#39;</span></span>'
    ...
    def test_string_subclass_repr(self):
        ...
        assert debug_repr(Test('foo')
            ) == '<span class="module">test_debug.</span>Test(<span class="string">&#39;foo&#39;</span>)'

    def test_sequence_repr(self):
        assert debug_repr(list(range(20))
            ) == '[<span class="number">0</span>, <span class="number">1</span>, <span class="number">2</span>, <span class="number">3</span>, <span class="number">4</span>, <span class="number">5</span>, <span class="number">6</span>, <span class="number">7</span>, <span class="extended"><span class="number">8</span>, <span class="number">9</span>, <span class="number">10</span>, <span class="number">11</span>, <span class="number">12</span>, <span class="number">13</span>, <span class="number">14</span>, <span class="number">15</span>, <span class="number">16</span>, <span class="number">17</span>, <span class="number">18</span>, <span class="number">19</span></span>]'

    def test_mapping_repr(self):
        assert debug_repr({}) == '{}'
        assert debug_repr({'foo': 42}
            ) == '{<span class="pair"><span class="key"><span class="string">&#39;foo&#39;</span></span>: <span class="value"><span class="number">42</span></span></span>}'
        ...
        assert debug_repr((1, 'zwei', 'drei')
            ) == '(<span class="number">1</span>, <span class="string">&#39;zwei&#39;</span>, <span class="string">&#39;drei&#39;</span>)'
    ...
    def test_list_subclass_repr(self):
        ...
        assert debug_repr(MyList([1, 2])
            ) == '<span class="module">test_debug.</span>MyList([<span class="number">1</span>, <span class="number">2</span>])'
