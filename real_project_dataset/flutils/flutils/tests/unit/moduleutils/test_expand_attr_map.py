...
from flutils.moduleutils import _AttrMapping, _expand_attr_map
...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.return_value = _AttrMapping("dname", "os.path", "dirname", self.item)
        patcher = patch(
            "flutils.moduleutils._expand_attr_map_item", return_value=self.return_value
        )
