...
from types import ModuleType as _ModuleType, SimpleNamespace as _SimpleNamespace
from typing import (
    Any as _Any,
    Dict as _Dict,
...
# noinspection PyUnusedClass,PyUnusedName,DuplicatedCode
class CompletedProcess(_NamedTuple):
    return_code: int
    stdout: str
    stderr: str
    cmd: str
...
class RunCmd:
    ...
    # noinspection PyUnusedFunction
    @property
    def default_kwargs(self) -> _NamedTuple: ...
...
def add_setup_cfg_commands(
    setup_kwargs: _Dict[str, _Any], setup_dir: _Optional[_Union[_PathLike, str]] = ...
) -> None: ...
...
# noinspection PyUnusedFunction
def bump_version(
    version: _STR, position: int = ..., pre_release: _Optional[str] = ...
) -> str: ...
...
# noinspection PyUnusedFunction
def get_encoding(name: _Optional[str] = ..., default: _Optional[str] = ...) -> str: ...
...
# noinspection PyUnusedFunction
def lazy_import_module(name: _STR, package: _Optional[_STR] = ...) -> _ModuleType: ...
...
# noinspection PyUnusedFunction
def prep_cmd(cmd: _Sequence) -> _Tuple[str, ...]: ...
...
# noinspection PyUnusedFunction
def to_namedtuple(obj: _AllowedTypes) -> _Union[_NamedTuple, _Tuple, _List]: ...

# noinspection PyUnusedFunction
def underscore_to_camel(text: _STR, lower_first: bool = ...) -> str: ...

# noinspection PyUnusedFunction
def validate_identifier(identifier: _STR, allow_underscore: bool = ...) -> None: ...
